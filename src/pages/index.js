      ...
      <header>
        ...
        <div className="card">
          ...
          <div className="details">
            ...
            <div className="Speed"><b>Speed:</b> 60 light years an hour</div>
            <div className="other-details">Galactic Demolition's model was created in 2275, one of America's greatest starships.</div>
          </div>
        </div>
        </body>
